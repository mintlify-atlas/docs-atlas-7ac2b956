...
description: "createSideffectWorkflowsPlugin() creates the Sideffect Vite plugin without invoking Cloudflare's plugin factory. Use for tests or custom composition."
---
