...
description: "API reference for Workflow.make() and WorkflowDefinition.toLayer(). Creates typed Cloudflare Workflow definitions and WorkflowLayer instances."
---
...
<ParamField path="options.payload" type="Schema.Schema<Payload>">
  ...
  If omitted, the payload is passed through as-is without decoding.
</ParamField>
