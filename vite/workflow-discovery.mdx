...
description: "Sideffect finds WorkflowLayer exports via static TypeScript AST — no runtime execution at build. Learn which patterns and file extensions are supported."
---
