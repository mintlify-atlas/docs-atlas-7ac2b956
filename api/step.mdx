---
title: "Step.make API Reference for Typed Cloudflare Workflow Steps"
sidebarTitle: "Step"
description: "API reference for Step.make(). Creates reusable, schema-validated Cloudflare Workflow step definitions with typed payloads and results."
---
...
<ParamField path="retries" type="WorkflowStepConfig[&quot;retries&quot;]">
  Cloudflare retry configuration for the step. The shape is defined by
  Cloudflare's `WorkflowStepConfig` type from `cloudflare:workers`.
</ParamField>

<ParamField path="timeout" type="WorkflowStepConfig[&quot;timeout&quot;]">
  Maximum execution time for the step. A Cloudflare duration string (e.g.
  `"5 minutes"`) or a number of milliseconds.
</ParamField>

<ParamField path="sensitive" type="WorkflowStepConfig[&quot;sensitive&quot;]">
