---
title: "withCloudflareWorkflows() Vite Plugin API"
sidebarTitle: "withCloudflareWorkflows"
description: "API reference for withCloudflareWorkflows(). Wraps @cloudflare/vite-plugin with Sideffect workflow discovery, auto-binding generation, and env type writing."
---
