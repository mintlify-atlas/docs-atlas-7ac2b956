---
title: "Rollback.with API Reference for Step Rollback Handlers"
...
<ParamField path="config" type="WorkflowStepConfig">
  ...
  the same `WorkflowStepConfig` type from `cloudflare:workers` that controls
  retries and timeout for the rollback execution.
</ParamField>
