...
description: "NonRetryableError signals a permanent workflow failure. Cloudflare Workflows will not retry when this error is thrown from a step or workflow run function."
---
